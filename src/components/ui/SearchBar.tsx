...
//                 />
//                 <button className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-white text-gray-400 rounded-full">
//                     <FaSearch />
//                 </button>
//             </div>
...
//                 <div className="absolute top-10 mt-2 p-3 bg-white text-gray-400 w-full rounded-xl left-1/2 -translate-x-1/2 flex flex-col gap-2">
        ...
        <form onSubmit={handleSubmit} className="w-[400px] relative">
            <div className="relative">
                <input 
                    ...
                    onChange={handleSearch} 
                />
                <button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-white text-gray-400 rounded-full">
                    <FaSearch />
                </button>
            </div>
